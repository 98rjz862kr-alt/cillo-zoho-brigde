...
if(logo.contentType!=='image/png' || boa.contentType!=='image/jpeg' || fleuve.contentType!=='image/jpeg')throw new Error('Hub assets must preserve canonical PNG/JPEG format');
