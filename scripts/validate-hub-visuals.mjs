...
if(boa.contentType!=='image/webp' || fleuve.contentType!=='image/webp')throw new Error('Hub editorial assets must be served as WebP');
...
console.log('Validated Hub LMI editorial visuals, local assets and protected asset loading.');
