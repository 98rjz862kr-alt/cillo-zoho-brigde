...
const OFFICIAL_LOGO_MARKUP = `<img class="lmi-official-logo" data-lmi-approved="official-logo-2026-08-20" data-lmi-asset="logo-lmi-hub.png" alt="${OFFICIAL_LOGO_ALT}" width="1000" height="635" loading="eager" decoding="async">`;
